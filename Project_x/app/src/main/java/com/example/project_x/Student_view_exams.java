...
public class Student_view_exams extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_view_exams);
...
//        Toast.makeText(getApplicationContext(), "No posts to show you.!"+e_id, Toast.LENGTH_LONG).show();
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Student_view_exams.this);
